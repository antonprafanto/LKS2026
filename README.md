# LKS 2026 — Robot Bergerak Otonom (Autonomous Mobile Robotics)

Repositori pendukung juri **LKS Pendidikan Menengah Tingkat Nasional XXXIV 2026**.

## Panduan Juri — Modul E & Log Run

**Bingung cara pakai Excel Modul E?** Baca panduan runut ini (bukan hanya SOP ringkas):

| Dokumen | Link |
|---------|------|
| **Panduan lengkap Modul E** (Undian → penilaian 60 poin) | [`docs/PANDUAN-MODUL-E.md`](docs/PANDUAN-MODUL-E.md) |
| **Panduan lengkap Log Run** (SIAP/START, checklist, kronologi) | [`docs/PANDUAN-LOG-RUN.md`](docs/PANDUAN-LOG-RUN.md) |
| Daftar semua panduan | [`docs/README.md`](docs/README.md) |
| File latihan (sudah terisi contoh) | [`templates/LKS2026-Penilaian-Juri-CONTOH.xlsx`](templates/LKS2026-Penilaian-Juri-CONTOH.xlsx) |

## Isi Repositori

| Folder / File | Deskripsi |
|---------------|-----------|
| [`docs/PANDUAN-MODUL-E.md`](docs/PANDUAN-MODUL-E.md) | **Panduan runut Modul E** — Undian, Hasil Run, RETRY, troubleshooting |
...
- Kisi-kisi & Deskripsi Teknis: [Pusat Prestasi Nasional](https://smk.pusatprestasinasional.kemdikdasmen.go.id)
- CAD L-Channel: [Google Drive](https://drive.google.com/drive/folders/1xpbziLSLvmT-wKWaHIRK2A7eIz5fIM9P?usp=share_link)
- **Marking Scheme Excel CIS** — wajib dimiliki Chief Expert (tidak termasuk repo ini)

## Bobot Modul

| Modul | Kriteria | Bobot |
|-------|----------|-------|
| A | Organisasi dan Manajemen Kerja | 8% |
| B | Jurnal / Laporan Teknis | 10% |
| C | Pembuatan dan Perakitan Robot | 10% |
| D | Gerakan Dasar & Manajemen Objek | 12% |
| E | Performansi Robot Sistem Otonom | 60% |
